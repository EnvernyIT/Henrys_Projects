...
public class Atleet {
	...
	public static void main(String arg[]) {
		...
		for(int i = 0; i < 50; i++) {
			...
			atletenArray[i] = new Atleet(namesArray[naamNummerArray], achterNamenArray[naamAchterNummerArray], LocalDate.of(jaarArray, maandArray, dagArray), nieuwSportArray);
 ;
		}
...
//		}
		...
		//Zorgt voor verschillende voornamen
			...
			atleten.add(new Atleet(names[naamNummer], achterNamen[naamAchterNummer], LocalDate.of(jaar, maand, dag), nieuwSport));
			numberOfAtleten++;
		}
		System.err.println("De atleten zijn: ");
